...
export const ORGANS = [
  ...
  // ---- Cardiovascular ----
  organ("heart", "Heart", "cardiovascular", { tag: "ellipse", cx: 138, cy: 175, rx: 22, ry: 26 },
  ...
  organ("lung-l", "Left Lung", "respiratory", { tag: "ellipse", cx: 115, cy: 175, rx: 28, ry: 55 },
  ...
  organ("lung-r", "Right Lung", "respiratory", { tag: "ellipse", cx: 185, cy: 175, rx: 28, ry: 55 },
  ...
  // ---- Digestive ----
  organ("stomach", "Stomach", "digestive", { tag: "ellipse", cx: 125, cy: 240, rx: 22, ry: 18 },
  ...
  organ("liver", "Liver", "digestive", { tag: "ellipse", cx: 175, cy: 225, rx: 30, ry: 20 },
