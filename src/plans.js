...
async function render() {
  ...
  box.innerHTML = `
    ...
    <div class="ai-tutor-preview">
      <strong>Kinetic AI Tutor</strong> — <em>in development, not connected yet.</em>
      <p>When it launches: Hint → Bigger Hint → Explain It, aware of your current simulation and challenge. Planned for paid Plus, capped around $3/month in estimated usage — not unlimited, and never promised as unlimited. <strong>Promo Plus does not include AI</strong>, even once it's live for paid Plus.</p>
    </div>
