...
export const ORGANISMS = [
  { id: "sun", fact: "Plants typically convert only around 1% of the sunlight that reaches them (a couple of percent at most) into chemical energy, and that sliver powers nearly every food chain on Earth.", name: "Sun", level: 0, eats: [], note: "Not alive, but every food chain traces back to its energy." },
  ...
  { id: "algae", fact: "Algae and other phytoplankton produce a large share of the oxygen we breathe \u2014 often estimated at around half.", name: "Algae", level: 1, eats: ["sun"], note: "A producer — the base of most aquatic food webs." },
  { id: "grasshopper", fact: "A grasshopper can jump many times its own body length.", name: "Grasshopper", level: 2, eats: ["grass"], note: "A primary consumer (herbivore) — eats producers directly." },
  ...
  { id: "hawk", fact: "Many hawks see detail from farther away than we can \u2014 estimates put their sharpness at a few times a human's.", name: "Hawk", level: 4, eats: ["snake", "rabbit", "mouse"], note: "A tertiary (apex) consumer — nothing here regularly preys on it." },
